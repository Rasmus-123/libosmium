#ifndef OSMIUM_IO_DETAIL_PBFE_DECODER_HPP
#define OSMIUM_IO_DETAIL_PBFE_DECODER_HPP
        ...
        namespace detail {
            ...
            class PBFPrimitiveBlockDecoder {
                ...
                int32_t convert_pbf_lon(const int64_t c) const noexcept {
                    return int32_t((c * m_granularity + m_lon_offset) / osmium::io::detail::resolution_convert);
                }

                int32_t convert_pbf_lat(const int64_t c) const noexcept {
                    return int32_t((c * m_granularity + m_lat_offset) / osmium::io::detail::resolution_convert);
                }
            ...
            inline data_view decode_blob(const std::string& blob_data, std::string& output) {
                ...
                osmium::io::detail::pbf_compression use_compression = osmium::io::detail::pbf_compression::none;
                ...
                while (pbf_blob.next()) {
                    switch (pbf_blob.tag_and_type()) {
                        case protozero::tag_and_type(FileFormat::Blob::optional_bytes_raw, protozero::pbf_wire_type::length_delimited):
                            {
                                ...
                                if (data_len.size() > osmium::io::detail::max_uncompressed_blob_size) {
                        ...
                        case protozero::tag_and_type(FileFormat::Blob::optional_int32_raw_size, protozero::pbf_wire_type::varint):
                            ...
                            if (raw_size <= 0 || uint32_t(raw_size) > osmium::io::detail::max_uncompressed_blob_size) {
                                throw osmium::pbf_error{"illegal blob size"};
                            }
                            break;
                        case protozero::tag_and_type(FileFormat::Blob::optional_bytes_zlib_data, protozero::pbf_wire_type::length_delimited):
                            use_compression = osmium::io::detail::pbf_compression::zlib;
...
#ifdef OSMIUM_WITH_LZ4
                            use_compression = osmium::io::detail::pbf_compression::lz4;
                            compressed_data = pbf_blob.get_view();
                            break;
#else
            ...
            inline osmium::Box decode_header_bbox(const data_view& data) {
                    ...
                    osmium::Box box;
                    box.extend(osmium::Location{left  / osmium::io::detail::resolution_convert, bottom / osmium::io::detail::resolution_convert});
                    box.extend(osmium::Location{right / osmium::io::detail::resolution_convert, top    / osmium::io::detail::resolution_convert});
                        ...
                        case protozero::tag_and_type(OSMFormat::HeaderBlock::repeated_string_required_features, protozero::pbf_wire_type::length_delimited):
                            {
                                ...
                                if (!std::strncmp("OsmSchema-V0.6_AreaExtension-V0.1", feature.data(), feature.size())) {
...
#endif // OSMIUM_IO_DETAIL_PBFE_DECODER_HPP
