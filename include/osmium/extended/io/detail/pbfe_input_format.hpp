#ifndef OSMIUM_IO_DETAIL_PBFE_INPUT_FORMAT_HPP
#define OSMIUM_IO_DETAIL_PBFE_INPUT_FORMAT_HPP
...
#include <osmium/extended/io/detail/pbfe_decoder.hpp>
...
namespace osmium::extended {
    ...
    namespace io {
        ...
        namespace detail {
            ...
            class PBFParser final : public osmium::io::detail::Parser {
                ...
                static uint32_t check_size(uint32_t size) {
                    if (size > static_cast<uint32_t>(osmium::io::detail::max_blob_header_size)) {
                ...
                std::string read_from_input_queue_with_check(size_t size) {
                    if (size > osmium::io::detail::max_uncompressed_blob_size) {
            ...
            public:
                ...
                explicit PBFParser(osmium::io::detail::parser_arguments& args) :
                    Parser(args),
            ...
            const bool registered_pbfe_parser = osmium::io::detail::ParserFactory::instance().register_parser(
	            osmium::io::file_format::pbfe,
                [](osmium::io::detail::parser_arguments& args) {
                    return std::unique_ptr<osmium::io::detail::Parser>(new PBFParser{args});
            });

            // dummy function to silence the unused variable warning from above
            inline bool get_registered_pbfe_parser() noexcept {
                return registered_pbfe_parser;
            }
...
#endif // OSMIUM_IO_DETAIL_PBFE_INPUT_FORMAT_HPP
